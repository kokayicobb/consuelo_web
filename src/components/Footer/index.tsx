          ...
          <div className="mb-10 w-full">
            <Link href="/" className="mb-6 inline-block max-w-[160px]">
              <Image
                ...
                width={180}
                height={25}
                className="max-w-full h-auto" // Ensure proper scaling
              />
            </Link>
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                The Fitting Room Company
              </p>
              <div className="-mx-3 flex items-center">
              <a
                  aria-label="social link"
                  href="https://www.linkedin.com/company/104462908"
                ...
                <a
                  aria-label="social link"
                  href="https://www.instagram.com/getconsuelo/profilecard/?igsh=MXNoamtwa2dnOGxoaw=="
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                    width="22"
