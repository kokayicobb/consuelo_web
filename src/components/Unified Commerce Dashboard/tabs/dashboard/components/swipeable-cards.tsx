...
export default function AICRMSwipeableCards() {
  ...
  return (
    <Card className="border-gray-200 bg-white relative overflow-hidden">
        ...
        {currentCard === 0 && (
          <div className="space-y-3">
            {nextActions.map((contact) => (
              <div
                key={contact.id}
                className="border rounded-lg p-3 hover:bg-gray-50 cursor-pointer" // This is your clickable card
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  {/* Apply pointer-events-none to the Badge */}
