  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="prose prose-gray max-w-none">
        <h1 className="text-3xl font-bold mb-6">Privacy Policy for Consuelo</h1>
        
        <p className="text-gray-600 italic mb-8">
          <strong>Last updated: August 08, 2025</strong>
        </p>
        ...
        <ul className="mb-6 space-y-2">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Consuelo, 127 Dalton Lane, NC, 28711.</li>
          ...
          <li><strong>Website</strong> refers to Consuelo, accessible from https://www.consuelohq.com/</li>
        ...
        <ul className="mb-6">
          <li>By email: contact@consuelohq.com</li>
          <li>By visiting this page on our website: https://www.consuelohq.com/contact</li>
        </ul>
      </div>
    </div>
  );
